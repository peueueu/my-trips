...
export type GetPageBySlugQuery = { __typename?: 'Query', page?: { __typename?: 'Page', id: string, heading?: string | null, slug: string, body: { __typename?: 'RichText', html: string } } | null };

export type GetPlacesQueryVariables = Exact<{ [key: string]: never; }>;


export type GetPlacesQuery = { __typename?: 'Query', places: Array<{ __typename?: 'Place', id: string, slug: string, name: string, location: { __typename?: 'Location', latitude: number, longitude: number } }> };
